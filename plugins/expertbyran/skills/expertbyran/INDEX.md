...
| `cyber` | Cyberexperten | Cybersäkerhet, informationssäkerhet, säkerhetsskyddslagen | Säkerhetsskyddsanalys, NIS2/cybersäkerhetslagen (sektortillsyn), DORA, AI-säkerhet (adversarial ML, OWASP LLM Top 10, NIST AI RMF), riskbedömningsmetodik (ISO 27005/NIST 800-30), NCSC, SÄPO-tillsyn, kritisk infrastruktur |
