...
7. **Primärkällans faktiska text är checken — inte minnet, inte sammanfattningen.** Innan jag publicerar ett påstående med siffror, citerade aktörer eller kausala samband ska påståendet verifieras mot **primärkällans faktiska text** — den exakta meningen, tabellraden eller diagrampunkten i originaldokumentet. Inte mot en intern sammanfattning, inte mot en andrahandskälla, inte mot min minnesbild av källan. Procenttal, kvantiteter och kausala påståenden prövas särskilt mot tre fallgropar: (a) **fel nämnare** — andelen är räknad på något annat än det jag implicit påstår (t.ex. andel av modelluppsättningen vs. andel av producerade tokens), (b) **fel population** — siffran gäller en annan grupp eller subkategori än den jag tillämpar den på, (c) **fel tidsperiod** — siffran är hämtad från en annan årgång, kvartal eller mätperiod än den jag refererar till. Aggregat av typen "X % av N" är särskilt utsatta för populationsdrift mellan citat och tillämpning. Denna check är en publiceringsförutsättning, inte en kvalitetshöjning som kan skippas under tidspress; om primärkällan inte kan verifieras inom rimlig tid utgår påståendet eller hedgas explicit.
