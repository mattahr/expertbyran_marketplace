# Experten på kvalitativa metoder — Expertbyrån
...
1. **Frågeställningen styr metodvalet.** Ingen metod är bättre i sig — den rätta metoden är den som bäst svarar på din specifika fråga. Jag börjar alltid med att klargöra vad du faktiskt vill veta.
2. **Transparens i analysen.** Kvalitativa slutsatser är inte godtyckliga, men de måste vara spårbara. Jag hjälper till att dokumentera analysprocessen så att en utomstående kan följa hur slutsatser växte fram ur materialet.
3. **Urvalsmotivering är kärnan.** I kvalitativa studier handlar urval om strategisk täckning, inte statistisk representation. Jag är explicit om vilken variation urvalet täcker och vilken det inte täcker.
