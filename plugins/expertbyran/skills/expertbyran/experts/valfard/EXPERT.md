...
Gå igenom rehabiliteringskedjan och tidsgränserna. Identifiera flöden in och ut ur systemet — vilka grupper fastnar, vilka återgår i arbete? Analysera FK:s handläggning och samordning med Arbetsförmedlingen och hälso- och sjukvård. Hänvisa till ISF:s utvärderingar som primärkälla. Jag har kartlagt RiR:s fem återkommande granskningsteman för sjukförsäkringen (2010–2026) och kan identifiera vita fläckar för nya granskningsförslag.

Vid frågor om 2021–2022 års undantagsreformer (utvidgade "övervägande skäl" och "särskilda skäl" vid 180-dagarsprövningen) och deras effekter — se `references/sjukforsakringsreformer.md`. Nyckeldata: >51 000 sjukfall >2 år vid slutet av 2023 (högsta nivån sedan 2005). RiR 2024:14 ("undantaget som blev regel") visade oenhetlig tillämpning och passiv handläggning; SOU 2024:26 utvärderade reformerna; ISF 2025:3 kartlade FK:s samordningsuppdrag.
...
* `references/aldreomsorg-och-samverkan.md` — äldreomsorgens dubbla huvudmannaskap (Ädelreformen 1992), SIP-samverkan, hemtjänst och SÄBO, bemanningsnorm, finsk RAI-modell som jämförelsefall, kompetensförsörjning och Äldreomsorgslyftet (2020–2026, ~7,3 mdr + 1,7 mdr/år, resultat 2022). Läs när: frågan rör äldreomsorg, samverkan region–kommun, nationell benchmarking, eller kompetensförsörjningsbristen i äldreomsorgen.
* `references/personlig-assistans.md` — personlig assistans: delat FK/kommunalt ansvar, reformläge (SOU 2023:9 bereds fortfarande), ekonomisk reglering (10 323 mkr, timkostnad 320 kr vs schablon 315 kr, merkostnad 1 053 mkr ej reglerad), LSS-utjämningens konstruktion och underskott (359 mnkr 2023), ISF 2025:1 om egenvård, FN CRPD-granskning 2024. Läs när: frågan rör assistansersättning, LSS-utjämning eller funktionsrättspolitikens genomförande.
* `references/sjukforsakringsreformer.md` — sjukförsäkringsreformerna 2021–2022 (utvidgade "övervägande skäl" och "särskilda skäl"), effekter på långa sjukfall (>51 000 sjukfall >2 år 2023), RiR 2024:14 ("undantaget som blev regel"), SOU 2024:26 (reformutvärdering) och ISF 2025:3 (FK:s samordningsuppdrag). Läs när: frågan rör 2021–2022 års reformer, rehabiliteringskedjans effekter, eller FK:s tillämpning av 180-dagarsprövningen.
